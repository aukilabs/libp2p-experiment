...
func findNode(ctx context.Context, nodeType string) (peer.ID, error) {
	for _, node := range nodeList {
...
func findNodes(ctx context.Context, nodeType string) ([]peer.ID, error) {
...
// func downloadDomainData(ctx context.Context, h host.Host, domainID string) {
// 	node, err := findNode(ctx, DISCOVERY_NODE)
// 	if err != nil {
// 		log.Println(err)
// 		return
// 	}
// 	s, err := h.NewStream(ctx, node, DOMAIN_AUTH_PROTOCOL_ID)
// 	if err != nil {
// 		log.Println(err)
// 		return
// 	}
...
// 				log.Println("Domain found")
// 				break
// 			}
// 		}
// 	}()
// 	builder := flatbuffers.NewBuilder(0)
// 	dID := builder.CreateString(domainID)
// 	Libposemesh.DownloadDomainDataStart(builder)
// 	Libposemesh.DownloadDomainDataAddDomainId(builder, dID)
// 	d := Libposemesh.DownloadDomainDataEnd(builder)
